...
from lib.outputs.csv import generate_csv_files as generate_csv_output
...
def main():
    ...
    # Generate CSV files using new module
    generate_csv_output(recordings_data, summary, output_dir)
    ...
    generate_mermaid_charts(recordings_data, daily_summary, word_freq, mode_data, topic_data, output_dir, config, hourly_data, filler_data)
