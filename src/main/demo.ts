...
// Banks are deliberately large — total unique tokens across all banks
// runs into the thousands so the Vocabulary growth curve has actual
// ceiling room as the dataset grows.
const BANK = {
  subject: [
    'I',
    'We',
  ...
  topic: [
    ...
    'the retention curve',
    'the churn cohort',
    'the customer interview transcript',
    'the user research synthesis',
    'the qualitative theme',
    'the quantitative signal',
    'the experiment hypothesis',
    'the holdout group',
    'the variant treatment',
    'the budget envelope',
  ...
  reason: [
    ...
    'the privacy review questions',
    'the encryption posture audit',
    'the cohort-size limit',
    'the holdout-power calculation',
    'the variance in the activation funnel',
    'the brand guideline ambiguity',
    'the unresolved survey themes',
    'the upstream-team change-freeze'
  ],
  // Domain-flavour nouns sprinkled into longer templates — never the only
  // word in a slot, but they push the unique-token count up sharply.
  domain: [
    'authentication',
    'authorisation',
    'observability',
