 ...
 *
 * Hand-rolled rather than pulling in @radix-ui/react-switch — the
 * surface area we need is minimal and the visual treatment matches the
 * rest of Settings (small, neutral) better than the Radix default.
 */
