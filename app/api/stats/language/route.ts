...
export async function GET(req: NextRequest) {
  ...
  if (profile === 'on') {
    ...
    return NextResponse.json({
      wordFrequency: legacy.wordFrequency,
      fillerSummary: legacy.fillerSummary,
      wpmTrend: [],
    })
  }
  ...
  return NextResponse.json({
    wordFrequency: cache.wordFrequency,
    fillerSummary: cache.fillerSummary,
    wpmTrend: cache.wpmTrend,
  })
}
